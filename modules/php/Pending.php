...
class Pending extends Game
{
    ...
    */
    ...
    function ActionsBonus($parg1, $parg2, $varg1, $varg2, $varg3, $varg4)
    {
        if ($varg1 == null) {
            ...
            $actions_restantes = game::$instance->getObjectListFromDB("SELECT name FROM actionpending WHERE count >= 1 AND name != 'clue' AND name != 'ghost'", true);
            $liste = '';
    ...
    */
    ...
    function getNumbersLogs($type)
    {
        if ($type >= 1) {
            return "<div class='numbers numb_{$type}' title=''></div>";
        } else {
            return "";
        }
    }
